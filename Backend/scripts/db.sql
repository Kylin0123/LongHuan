...
VALUES ('1', '管理员1', 100, '男', '12345678901', "wx_id_0001", "12345678@sample.com", "我是管理员1"),
('2', '管理员2', 100, '男', '12345678902', "wx_id_0002", "12345678@sample.com", "我是管理员2"),
('3', '管理员3', 100, '男', '12345678903', "wx_id_0003", "12345678@sample.com", "我是管理员3");
...
CREATE TABLE `lesson` (
  ...
  `desc_info` varchar(200) DEFAULT NULL,/* 课程描述 */
  `title` varchar(32) DEFAULT NULL,     /* 新品、火热 */
  `image` varchar(50) DEFAULT NULL,     /* 图片 */
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;
